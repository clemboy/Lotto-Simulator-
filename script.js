document.addEventListener('DOMContentLoaded', () => {
    ...
    const ticketTimeElement = document.getElementById('ticket-time'); // Added ticket time element reference
    ...
    submitNumbersButton.addEventListener('click', () => {
        ...
        updateTicketTime(); // Update ticket time on submit
        alert('Numbers saved!');
    });
    ...
    function updateTicketTime() {
        ...
        ticketTimeElement.textContent = `Current Time: ${formattedTime}`;
    }
    ...
    // Initialize ticket time on page load
    updateTicketTime();
});
